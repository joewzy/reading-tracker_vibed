        ...
        <div className={styles.landingGrid}>
          ...
          >
            <div className={styles.heroBadge}>
              <Sparkles size={13} />
              <span>Your AI-Powered Reading Coach</span>
            </div>

            <h1 className={styles.heroTitle}>
              Level Up<br />
              <span className={styles.heroTitleAccent}>Your Reading</span><br />
              Life.
            </h1>

            <p className={styles.heroDesc}>
              ReaderVerse turns every page into progress. Track habits, earn XP, get AI-curated picks — and never lose your reading streak.
            </p>
            ...
            <div className={styles.socialProof}>
              <div className={styles.avatarStack}>
                {['🧑‍💻','👩‍🎓','🧑‍🏫','👨‍💼','👩‍🔬'].map((e, i) => (
                  <div key={i} className={styles.avatar} style={{ zIndex: 5 - i }}>{e}</div>
                ))}
              </div>
              <p><strong>2,400+ readers</strong> already leveling up</p>
            </div>
          </motion.div>
          ...
          >
            <div className={styles.authCard}>
              <div className={styles.authCardHeader}>
                ...
                <div>
                  ...
                  <p className={styles.authCardSub}>
                    {authMode === 'login' ? 'Pick up where you left off' : 'Join thousands of readers'}
                  </p>
                </div>
              </div>

              <div className={styles.authTabs}>
                <button className={`${styles.authTab} ${authMode === 'login' ? styles.activeAuthTab : ''}`} onClick={() => setAuthMode('login')}>Log In</button>
              ...
              <div className={styles.oauthRow}>
                ...
                <button className={styles.oauthBtn} onClick={() => signIn('github')}>
                  <Github size={18} />
                  GitHub
                </button>
              </div>
